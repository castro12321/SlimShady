...
{
    public class HardwareBrightnessComponent : BrightnessMonitorComponent
    {
        ...
        public override uint CurrValue
        {
            ...
            set
            {
                ...
                {
                    physicalMonitor.SetBrightness(value);
                    currValue = value;
        ...
        public HardwareBrightnessComponent(PhysicalMonitor physicalMonitor, uint minValue, uint maxValue, uint currValue)
        {
